    ...
    for epoch in range(epochs):
        ...
        for i, samples in enumerate(zip(valid_loader05, valid_loader075, 
            ...
            with torch.no_grad():
                ...
                feature_vector.append(abs(i_idx_norm[0] - i_idx_norm[1]))
                feature_vector.append(abs(i_idx_norm[0] - i_idx_norm[2]))
                feature_vector.append(abs(i_idx_norm[1] - i_idx_norm[2]))
                feature_vector.append(abs(j_idx_norm[0] - j_idx_norm[1]))
                feature_vector.append(abs(j_idx_norm[0] - j_idx_norm[2]))
                feature_vector.append(abs(j_idx_norm[1] - j_idx_norm[2]))
