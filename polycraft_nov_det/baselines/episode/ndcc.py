...
if __name__ == '__main__':
    ...
    # eval model
        ...
        output_folder = Path("models/episode/ndcc/")
        test_loader = episode_dataloader("test", VGGPreprocess(), opt.batch_size)
        save_scores(NDCCDetector(model, device), output_folder, test_loader)
